<?php
function changePassword($servername, $username, $password, $dbname, $customer_username, $newPassword, $confirmPassword)
{
...
if (isset($_POST["customer_username"]) && isset($_POST["newuserpass"]) && isset($_POST["confirmuserpass"])) {
    $customer_username = $_POST["customer_username"];
    $newPassword = $_POST["newuserpass"];
    $confirmPassword = $_POST["confirmuserpass"];

    $result = changePassword($servername, $username, $password, $dbname, $customer_username, $newPassword, $confirmPassword);
