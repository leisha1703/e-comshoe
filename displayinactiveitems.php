...
$sql = "SELECT * FROM productregisteration WHERE vendoruserid='$vendor_username' AND status='Inactive' ORDER BY id DESC";
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      ...
      <div class="offcanvas-body">
		...
		<li class="nav-item">
		  ...
		  <li class="nav-item">
            <a class="nav-link active" href="displayinactiveitems.php">Display Inactive Items</a>
          </li>
		  <li class="nav-item">
...
<div class="container">
<h1 style="margin-bottom:50px;text-align:center;margin-top:20px;">All Inactive Items List</h1>
<table>
  <tr>
    <th>ID</th>
    <th>Item Name</th>
