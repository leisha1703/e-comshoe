...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (isset($_POST["id"]) && isset($_POST["status"])) {
        ...
        $sql = "UPDATE userinformation SET status = ? WHERE id = ? AND type='Customer' ";
...
if (isset($_GET["customer_username"])) {
    ...
    $sql = "SELECT * FROM userinformation WHERE username = ? AND type='Customer' AND status='active'";
    $stmt = mysqli_prepare($conn, $sql);
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        <a class="nav-link active" href="allcustomers.php">Customers</a>
...
<br><br>
<div class="container">
    <h1 style="text-align: center; margin-top: 20px;">List of all Customers</h1><br>
    <table class="table">
        <thead>
            <tr>
                <th>ID</th>
