...
if (isset($_GET["status"])) {
    ...
    if ($status === "Select Status") {
        ...
        $sql = "SELECT * FROM userinformation WHERE type='Vendor' AND status = '$status'";
    }
...
if (isset($_GET["vendor_username"])) {
    ...
    $vendor_username = $_GET["vendor_username"];
    $sql = "SELECT * FROM userinformation WHERE username = '$vendor_username' AND type='Vendor'";
    $result = mysqli_query($conn, $sql);
}
} else {
}
// Include the online_users.php file here to get the online user count
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
		...
		<a class="nav-link active" href="list2.php">Vendors status</a>
...
<br><br>
    ...
    <div class="container">
        <h1 style="text-align: center; margin-top: 50px;">Check status of vendors</h1><br>
        <table class="table">
            <thead>
                <tr>
                    <th>ID</th>
