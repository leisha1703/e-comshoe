...
if (isset($_SESSION["customer_username"])) {
    ...
    $sql = "SELECT * FROM vendor_inquiries WHERE customer_id = '$customer_username' ";
...
if (isset($_GET["itemname"])) {
    ...
    $sql = "SELECT * FROM vendor_inquiries WHERE customer_id = ? AND item_name = ?";
      ...
      <div class="offcanvas-body">
		...
		<li class="nav-item">
		 ...
		 <li class="nav-item">
		  ...
		  <li class="nav-item">
            <a class="nav-link active" href="trackinquiry.php">Track Enquiry</a>
          </li>
		  <li class="nav-item">
...
<br><br>
    <div class="container">
        <h1 style="margin-bottom: 20px; text-align: center;">Track Inquiry Status</h1>
